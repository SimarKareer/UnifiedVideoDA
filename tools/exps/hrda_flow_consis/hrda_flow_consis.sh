...
python tools/uda_test.py /coc/testnvme/skareer6/Projects/VideoDA/mmsegmentation/configs/hrda/gtaHR2csHR_hrda.py /coc/testnvme/skareer6/Projects/VideoDA/mmsegmentation/work_dirs/HRDA/gtaHR2csHR_hrda_246ef/iter_40000_relevant.pth --eval mIoU --launcher none
...
srun -p ${PARTITION} \
    ...
    python -u ./tools/train.py ./configs/mic/viperHR2csHR_mic_daformer.py --launcher="slurm" --l-warp-lambda -1 --l-mix-lambda 1 --imnet-feature-dist-lambda=0 --optimizer adamw --lr-schedule poly_10_warm --lr 6e-5 --total-iters=40000 --work-dir="./work_dirs/mmv1/${FULL_JOB_NAME}" --wandbid=${FULL_JOB_NAME}

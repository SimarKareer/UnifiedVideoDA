...
srun -u python -u ./tools/train.py configs/mic/viperHR2csHR_mic_hrda.py --launcher=slurm --no-masking True --l-warp-lambda=1.0 --l-warp-begin=0 --l-mix-lambda=0.0 --warp-cutmix True --pl-fill True --consis-filter True --load-from /coc/scratch/vvijaykumar6/mmseg/work_dirs/analysisPaper/viper/viper_hrda_consis_backward_1f08-25-14-19-04/latest.pth --seed 1 --total-iters=50 --deterministic --work-dir=./work_dirs/analysisPaper/viper/$1$T --auto-resume True --nowandb True --debug-mode True
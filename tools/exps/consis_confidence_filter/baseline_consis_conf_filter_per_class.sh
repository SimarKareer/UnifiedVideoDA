...
srun -u python -u ./tools/train.py configs/mic/viperHR2csHR_mic_hrda.py --launcher="slurm" --l-warp-lambda=1 --l-warp-begin=1500 --l-mix-lambda=1 --warp-cutmix True --bottom-pl-fill True --consis-confidence-filter True --consis-confidence-thresh 0.5 --consis-confidence-per-class-thresh True --optimizer adamw --lr-schedule poly_10_warm --lr 24e-5 --total-iters=15000 --work-dir="./work_dirs/consis_confidence_filter_train/$1$T" --wandbid $1$T
# --wandbid $1$T
# --wandbid $1$T
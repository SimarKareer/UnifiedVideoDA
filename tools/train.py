...
def main(args):
    ...
    model.model = WeTrLinearFusion("mit_b5", config, num_classes = config['num_classes'])
    model.model.load_state_dict(torch.load('/coc/testnvme/hmaheshwari7/vdammtemp.pth'))
